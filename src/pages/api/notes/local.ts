...
async function getLocal(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    const apiURL = new URL("/api/notes/local-timeline", origin?.toString())
